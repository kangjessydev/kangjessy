...
import { r as runMain$1, t as defineCommand } from "./dist-sJJifug_.mjs";
import { n as colors } from "./consola.DXBYu-KD-BxkQ5_xB.mjs";
import "./utils-D5jIbZ8_.mjs";
import { a as p$1 } from "./dist-KRhCJXtj.mjs";
import { n as name, r as version, t as description } from "./package-vAVTxU4x.mjs";
import { t as cwdArgs } from "./_shared-CoPxtaYg.mjs";
import { t as templates } from "./templates-CMadjP-l.mjs";
import { t as runCommand } from "./run-CnXlOE2S.mjs";
import { t as consola } from "./dist-DoMAwH4O.mjs";
import { n as logger, t as debug } from "./logger-C9cMUJ6F.mjs";
import { t as templateNames } from "./templates-Ck0_sg5y.mjs";
...
const commands = {
	"add": () => import("./add-eXXithXn.mjs").then(_rDefault),
	"add-template": () => import("./add-template-CAPtDrDM.mjs").then(_rDefault),
	"analyze": () => import("./analyze-CkbhFDjq.mjs").then(_rDefault),
	"build": () => import("./build-0VWSSMdh.mjs").then(_rDefault),
	"cleanup": () => import("./cleanup-CREKzCd2.mjs").then(_rDefault),
	"_dev": () => import("./dev-child-DYNc-Kz6.mjs").then(_rDefault),
	"dev": () => import("./dev-BV8N8rY8.mjs").then(_rDefault),
	"devtools": () => import("./devtools-Bi_pTffh.mjs").then(_rDefault),
	"generate": () => import("./generate-ey_Z99Q1.mjs").then(_rDefault),
	"info": () => import("./info-CIZ-xpoU.mjs").then(_rDefault),
	"init": () => import("./init-DZB4PmiV.mjs").then(_rDefault),
	"module": () => import("./module-Cl-rloY_.mjs").then(_rDefault),
	"prepare": () => import("./prepare-f7KKmEfj.mjs").then(_rDefault),
	"preview": () => import("./preview-DcwtvU2a.mjs").then(_rDefault),
	"start": () => import("./preview-DcwtvU2a.mjs").then(_rDefault),
	"test": () => import("./test-CNVG4vXx.mjs").then(_rDefault),
	"typecheck": () => import("./typecheck-CTgD3V8W.mjs").then(_rDefault),
	"upgrade": () => import("./upgrade-DluARWCQ.mjs").then(_rDefault)
};

//#endregion
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.12_cac@6.7.14_citty@0.2.0/node_modules/@bomb.sh/tab/dist/t-DYl0qC9V.js
function t(e, t) {
	return `#compdef ${e}
compdef _${e} ${e}
...
function r(e, t) {
	let n = e.replace(/[-:]/g, `_`), r = a.ShellCompDirectiveError, i = a.ShellCompDirectiveNoSpace, o = a.ShellCompDirectiveNoFileComp, s = a.ShellCompDirectiveFilterFileExt, c = a.ShellCompDirectiveFilterDirs;
	return `# fish completion for ${e} -*- shell-script -*-
...
function i(e, t) {
	let n = e.replace(/[-:]/g, `_`);
	return `# powershell completion for ${e} -*- shell-script -*-
...
//#endregion
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.12_cac@6.7.14_citty@0.2.0/node_modules/@bomb.sh/tab/dist/shared-BE1U9MBi.js
function e(e = `cli`) {
...
//#endregion
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.12_cac@6.7.14_citty@0.2.0/node_modules/@bomb.sh/tab/dist/citty.js
async function s(e) {
	let t = [], n = [];
...
async function _(e, t, n) {
	for (let [i, a] of Object.entries(e)) {
		let e = await y(a), o = await y(e.meta), s = await y(e.subCommands), c = n?.[i];
		if (!o || typeof o?.description != `string`) throw Error(`Invalid meta or missing description.`);
		let l = g(e), u = t ? `${t} ${i}` : i, d = f$1.command(u, o.description);
...
async function v(s, c) {
	...
	if (g(s) && s.args) for (let [e, t] of Object.entries(s.args)) {
		...
		if (n.type === `positional`) {
			let t = n.required === !1, i = c?.args?.[e];
			i ? f$1.argument(e, i, t) : f$1.argument(e, void 0, t);
		}
	}
	if (f && await _(f, void 0, c?.subCommands), s.args) for (let [e, t] of Object.entries(s.args)) {
		let n = t, i = typeof n == `object` && `alias` in n ? Array.isArray(n.alias) ? n.alias[0] : n.alias : void 0, a = c?.options?.[e];
		a ? i ? f$1.option(e, n.description ?? ``, a, i) : f$1.option(e, n.description ?? ``, a) : i ? f$1.option(e, n.description ?? ``, i) : f$1.option(e, n.description ?? ``);
	}
	let p = defineCommand({
		meta: {
			name: `complete`,
		...
		async run(o) {
			...
			switch (c === `--` && (c = void 0), c) {
				...
				default: {
					...
					return f$1.parse(e$1);
				}
			}
		}
	});
	return f ? f.complete = p : s.subCommands = { complete: p }, f$1;
}
async function y(e) {
...
async function checkEngines() {
	const satisfies = await import("./satisfies-uKNpXreY.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1)).then((r) => r.default || r);
...
const _main = defineCommand({
	...
	async setup(ctx) {
		...
		let backgroundTasks;
		if (command !== "_dev" && p$1 !== "stackblitz") backgroundTasks = Promise.all([checkEngines()]).catch((err) => logger.error(err));
		...
		if (command === "add" && ctx.rawArgs[1] && templateNames.includes(ctx.rawArgs[1])) {
			...
			await runCommand(await import("./add-template-CAPtDrDM.mjs").then((m) => m.default || m), [...ctx.rawArgs.slice(1)]).catch((err) => {
		...
		if (ctx.args.command && !(ctx.args.command in commands)) {
			...
			try {
				const { x } = await import("./main-IycWRW3O.mjs");
