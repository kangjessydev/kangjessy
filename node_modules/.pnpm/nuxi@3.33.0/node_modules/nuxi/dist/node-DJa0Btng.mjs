	...
	return bi || (bi = 1, function(i, o) {
		(function(a, f) {
			...
			function os(e, t) {
				...
				function Te() {}
				return n(Te, "startAlgorithm"), y = Et(Te, ae, nt), C = Et(Te, ae, Oe), I(r._closedPromise, (x) => (oe(y._readableStreamController, x), oe(C._readableStreamController, x), (!c || !d) && P(void 0), null)), [y, C];
			}
...
const mr = Symbol.toStringTag, wi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n((i, o) => {
	...
	async formData() {
		...
		const { toFormData: a } = await import("./multipart-parser-CJR1dICF.mjs");
...
}, Fn = typeof nodeHTTP.validateHeaderValue == "function" ? nodeHTTP.validateHeaderValue : (i, o) => {
	if (/[^\t\u0020-\u007E\u0080-\u00FF]/.test(o)) {
...
const ml = f(pl()), { stat: $n } = promises, yl = n((i, o) => vi(statSync(i), i, o), "blobFromSync"), gl = n((i, o) => $n(i).then((a) => vi(a, i, o)), "blobFrom"), _l = n((i, o) => $n(i).then((a) => Ei(a, i, o)), "fileFrom"), Sl = n((i, o) => Ei(statSync(i), i, o), "fileFromSync"), vi = n((i, o, a = "") => new ut([new Sr({
	path: o,
	size: i.size,
