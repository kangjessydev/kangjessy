    ...
    <div class="p-6">
      ...
      <div class="mb-8">
        <div class="flex flex-col items-start max-w-[90%]">
          ...
          >
            <p>
              Halo! Silakan kirim detail pertanyaan atau proposal Anda melalui
              form di bawah ini. Saya akan membalas k email Anda secepatnya.
            </p>
            <span
      ...
      <div class="space-y-5">
        ...
        <div class="space-y-2">
          ...
          <input
            ...
            type="text"
            placeholder="Ringkasan pertanyaan..."
            class="w-full bg-bg-primary border border-border-color rounded-2xl px-5 py-4 text-text-primary text-[0.95rem] outline-none transition-all focus:border-red-500/50 focus:ring-4 focus:ring-red-500/5 placeholder:text-text-tertiary"
          />
        </div>
        ...
        <div class="space-y-2">
          ...
          <textarea
            ...
            rows="4"
            class="w-full bg-bg-primary border border-border-color rounded-2xl px-5 py-4 text-text-primary text-[0.95rem] outline-none transition-all focus:border-red-500/50 focus:ring-4 focus:ring-red-500/5 resize-none placeholder:text-text-tertiary"
          ></textarea>
        </div>
      </div>
