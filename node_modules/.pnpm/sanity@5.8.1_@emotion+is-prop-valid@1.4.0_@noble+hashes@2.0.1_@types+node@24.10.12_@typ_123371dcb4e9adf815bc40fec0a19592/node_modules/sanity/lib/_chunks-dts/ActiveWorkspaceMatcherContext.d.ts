...
import * as sanity__singletons3 from "sanity/_singletons";
...
import { EditorChange, EditorSelection, HotkeyOptions, OnCopyFn, OnPasteFn, PortableTextEditor, RangeDecoration, RangeDecorationOnMovedDetails, RenderBlockFunction } from "@portabletext/editor";
import * as styled_components4 from "styled-components";
import { ExecutionProps } from "styled-components";
import * as styled_components_dist_types6 from "/home/runner/work/sanity/sanity/node_modules/.pnpm/@sanity+styled-components@6.1.24_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@sanity/styled-components/dist/types.js";
...
import * as date_fns0 from "date-fns";
...
/** @internal */
declare function BetaBadge(props: BetaBadgeProps & Omit<HTMLProps<HTMLDivElement>, 'ref'>): react583.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare const CommandList: react583.NamedExoticComponent<CommandListProps<any> & react583.RefAttributes<CommandListHandle>>;
 ...
 * @internal
 */
declare const Button: react583.ForwardRefExoticComponent<(Omit<Pick<ButtonProps, "as" | "icon" | "iconRight" | "justify" | "loading" | "mode" | "paddingLeft" | "paddingY" | "selected" | "tone" | "type" | "width"> & {
  ...
  size?: "default" | "large" | undefined;
  radius?: "full" | undefined;
} & IconButton & Omit<HTMLProps<HTMLButtonElement>, "as" | "size" | "title">, "ref">) & react583.RefAttributes<HTMLButtonElement>>;
/** @internal */
 ...
 * @internal
 */
declare const ContextMenuButton: react583.ForwardRefExoticComponent<ContextMenuButtonProps & Pick<HTMLProps<HTMLButtonElement>, "disabled" | "hidden" | "onClick"> & react583.RefAttributes<HTMLButtonElement>>;
/**
 ...
 * @internal
 */
declare const Chip: react583.ForwardRefExoticComponent<Omit<Omit<_sanity_ui17.ButtonProps & Omit<react583.HTMLProps<HTMLButtonElement>, "as" | "width">, "ref"> & react583.RefAttributes<HTMLButtonElement>, "ref"> & react583.RefAttributes<unknown>>;
/**
 *
 ...
 * @internal
 */
declare const VersionChip: react583.NamedExoticComponent<{
...
/** @internal */
declare function ChangeIndicator(props: ChangeIndicatorProps & Omit<HTMLProps<HTMLDivElement>, 'as'>): react583.JSX.Element;
/** @internal */
...
declare function ChangeConnectorRoot({
  ...
  onSetFocus,
  ...restProps
}: ChangeConnectorRootProps): react583.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare const ChangeIndicatorsTracker: react583.MemoExoticComponent<typeof ChangeIndicatorsTrackerComponent>;
/**
 * @internal
 */
 ...
 * @hidden
 */
declare function CommentDeleteDialog(props: CommentDeleteDialogProps): react583.JSX.Element;
/**
 * @internal
 */
declare const CommentDisabledIcon: react583.ForwardRefExoticComponent<Omit<SVGProps<SVGSVGElement>, "ref"> & react583.RefAttributes<SVGSVGElement>>;
/**
 *
...
declare function useDialogStack({
  ...
  topEntry: sanity__singletons3.DialogStackEntry | null; /** The full stack of dialog entries (each has id and path) */
  stack: sanity__singletons3.DialogStackEntry[]; /** Check if this dialog is on top */
...
declare const studioLocaleStrings: {
  ...
  'default-orderings.title': string; /** Label to show in the document footer indicating the creation date of the document */
  ...
  'inputs.array.action.edit': string; /** Label for removing an array item action  */
  ...
  'inputs.object.unknown-fields.read-only.description': string; /** Remove field */
  ...
  'search.search-results-aria-label': string; /** Label for the edit columns button to change field visibility in sheet list */
  'sheet-list.edit-columns': string; /** Label for the header menu option to hide a field from the sheet list */
  'sheet-list.hide-field': string; /** Label for reset column visibilities button */
  'sheet-list.reset-columns': string; /** Title for the edit columns menu */
  'sheet-list.select-fields': string; /** Accessibility label for the navbar status button */
 ...
 * @hidden
 */
declare function LocaleProvider(props: PropsWithChildren): react583.JSX.Element;
/**
 * @internal
 * @hidden
 */
 ...
 * @public
 */
declare function Translate(props: TranslationProps): react583.JSX.Element;
 ...
 * while reconnecting.
 */
declare function CommentsAuthoringPathProvider(props: CommentsAuthoringPathProviderProps): react583.JSX.Element;
/**
 * @beta
 * @hidden
 */
 ...
 * @beta
 */
declare const CommentsProvider: react583.NamedExoticComponent<CommentsProviderProps>;
 ...
 * @hidden
 */
declare const CommentsEnabledProvider: react583.NamedExoticComponent<CommentsEnabledProviderProps>;
/**
 * @beta
 * @hidden
 */
 ...
 * @hidden
 */
declare const CommentsIntentProvider: react583.NamedExoticComponent<CommentsIntentProviderProps>;
 ...
 * @internal
 */
declare const CommentsSelectedPathProvider: react583.NamedExoticComponent<CommentsSelectedPathProviderProps>;
/**
 * @internal
 */
...
}: ActiveWorkspaceMatcherProps): react583.JSX.Element;
/** @internal */
...
declare function WorkspacesProvider({
  ...
  basePath,
  LoadingComponent
}: WorkspacesProviderProps): react583.JSX.Element;
/** @internal */
 ...
 * @hidden
 */
declare function AddonDatasetProvider(props: AddonDatasetSetupProviderProps): string | number | bigint | boolean | react583.JSX.Element | Iterable<react583.ReactNode> | Promise<string | number | bigint | boolean | Iterable<react583.ReactNode> | react583.ReactElement<unknown, string | react583.JSXElementConstructor<any>> | react583.ReactPortal | null | undefined> | null | undefined;
/**
 * @beta
 * @hidden
 */
...
declare function ColorSchemeProvider({
  ...
  onSchemeChange,
  scheme: schemeProp
}: ColorSchemeProviderProps): react583.JSX.Element;
/**
...
declare function ColorSchemeLocalStorageProvider({
  children,
  onSchemeChange
}: Pick<ColorSchemeProviderProps, 'children' | 'onSchemeChange'>): react583.JSX.Element;
/**
 ...
 * @internal
 */
declare const SearchHeader: react583.ForwardRefExoticComponent<SearchHeaderProps & react583.RefAttributes<HTMLInputElement>>;
...
declare function SearchPopover({
  ...
  previewPerspective,
  open
}: SearchPopoverProps): react583.JSX.Element;
...
declare function SearchResultItemPreview({
  ...
  showBadge,
  perspective
}: SearchResultItemPreviewProps): react583.JSX.Element;
/**
 * @internal
 */
...
declare const searchOperators: {
  ...
  arrayReferenceIncludes: SearchOperatorBuilder<"arrayReferenceIncludes", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"arrayReferenceIncludes">;
  arrayReferenceNotIncludes: SearchOperatorBuilder<"arrayReferenceNotIncludes", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"arrayReferenceNotIncludes">;
  assetFileEqual: SearchOperatorBuilder<"assetFileEqual", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"assetFileEqual">;
  assetFileNotEqual: SearchOperatorBuilder<"assetFileNotEqual", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"assetFileNotEqual">;
  assetImageEqual: SearchOperatorBuilder<"assetImageEqual", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"assetImageEqual">;
  assetImageNotEqual: SearchOperatorBuilder<"assetImageNotEqual", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"assetImageNotEqual">;
  ...
  referenceEqual: SearchOperatorBuilder<"referenceEqual", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"referenceEqual">;
  referenceNotEqual: SearchOperatorBuilder<"referenceNotEqual", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"referenceNotEqual">;
  referencesAssetFile: SearchOperatorBuilder<"referencesAssetFile", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"referencesAssetFile">;
  referencesAssetImage: SearchOperatorBuilder<"referencesAssetImage", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"referencesAssetImage">;
  referencesDocument: SearchOperatorBuilder<"referencesDocument", _sanity_types44.Reference> | ValuelessSearchOperatorBuilder<"referencesDocument">;
...
declare function SearchProvider({
  ...
  disabledDocumentIds,
  canDisableAction
}: SearchProviderProps): react583.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 */
declare const SearchButton: react583.ForwardRefExoticComponent<SearchButtonProps & react583.RefAttributes<HTMLButtonElement>>;
...
declare function SearchDialog({
  ...
  onOpen,
  open
}: SearchDialogProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
declare function StudioLogo(props: LogoProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function StudioNavbar(props: Omit<NavbarProps, 'renderDefault'>): react583.JSX.Element;
/**
 * @hidden
 * @beta */
declare function StudioToolMenu(props: ToolMenuProps): react583.JSX.Element | null;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare const ToolLink: react583.ForwardRefExoticComponent<Omit<ToolLinkProps & Omit<HTMLProps<HTMLAnchorElement>, "href" | "name">, "ref"> & react583.RefAttributes<HTMLAnchorElement>>;
/**
 * @hidden
 * @beta */
...
declare function SourceProvider({
  children,
  ...props
}: SourceProviderProps): react583.JSX.Element;
/**
 * @internal
...
declare function StudioAnnouncementsCard({
  ...
  onCardClick,
  onCardDismiss
}: StudioAnnouncementCardProps): react583.JSX.Element;
...
declare function StudioAnnouncementsDialog({
  ...
  onClose,
  mode
}: StudioAnnouncementDialogProps): react583.JSX.Element;
/**
 * @internal
 * @hidden
 */
 ...
 * ```
 */
declare function StudioLayout(): react583.JSX.Element;
/**
 * @internal
 * The default Studio Layout component
 * */
declare function StudioLayoutComponent(): react583.JSX.Element;
/**
 * @hidden
 * @beta */
...
}: StudioProviderProps): react583.JSX.Element;
 ...
 * @internal
 */
declare const UpsellDialogViewed: _sanity_telemetry39.DefinedTelemetryLog<UpsellDialogViewedInfo>;
/**
 * @internal
 */
declare const UpsellDialogDismissed: _sanity_telemetry39.DefinedTelemetryLog<UpsellDialogActionsInfo>;
/**
 * @internal
 */
declare const UpsellDialogUpgradeCtaClicked: _sanity_telemetry39.DefinedTelemetryLog<UpsellDialogActionsInfo>;
/**
 * @internal
 */
declare const UpsellDialogLearnMoreCtaClicked: _sanity_telemetry39.DefinedTelemetryLog<UpsellDialogActionsInfo>;
/** @internal */
 ...
 * @internal
 */
declare function UpsellDescriptionSerializer(props: DescriptionSerializerProps): react583.JSX.Element;
/** @internal */
...
declare function ErrorMessage({
  ...
  path,
  stack
}: ErrorMessageProps): react583.JSX.Element;
...
declare function WorkspaceLoaderBoundary({
  ...
  ...props
}: WorkspaceLoaderProps): react583.JSX.Element;
/**
 * @beta
 * @hidden
 */
 ...
 * @hidden
 */
declare const CommentsList: react583.NamedExoticComponent<CommentsListProps & react583.RefAttributes<HTMLDivElement>>;
/**
 * @internal
 */
 ...
 * @hidden
 */
declare const CommentInput: react583.ForwardRefExoticComponent<CommentInputProps & react583.RefAttributes<CommentInputHandle>>;
 ...
 * @internal
 */
declare const CommentInlineHighlightSpan: react583.ForwardRefExoticComponent<Omit<CommentInlineHighlightSpanProps & react583.HTMLProps<HTMLSpanElement>, "ref"> & react583.RefAttributes<HTMLSpanElement>>;
/**
 * @internal
 * @hidden
 */
...
/** @internal */
declare const CollapseMenu: react583.ForwardRefExoticComponent<CollapseMenuProps & react583.RefAttributes<any>>;
/** @internal */
declare const AutoCollapseMenu: react583.ForwardRefExoticComponent<Omit<CollapseMenuProps, "children" | "collapsed"> & {
  menuOptions: react583.JSX.Element[];
} & react583.RefAttributes<HTMLDivElement>>;
/** @internal */
...
/** @internal */
declare const CollapseMenuButton: react583.ForwardRefExoticComponent<Omit<CollapseMenuButtonProps & Omit<HTMLProps<HTMLButtonElement>, "as" | "size">, "ref"> & react583.RefAttributes<HTMLButtonElement>>;
/** @internal */
 ...
 * @internal
 */
declare const ScrollContainer: react583.NamedExoticComponent<Omit<ScrollContainerProps<ElementType>, "ref"> & react583.RefAttributes<HTMLDivElement>>;
/** @internal */
...
declare function EventsProvider({
  value,
  children
}: EventsProviderProps): react583.JSX.Element;
/**
 * @internal
 */
...
/** @internal */
declare function ChangeResolver(props: ChangeResolverProps): react583.JSX.Element | null;
/**
 * @internal
 * */
...
/** @internal */
declare const DiffCard: react583.ForwardRefExoticComponent<Omit<DiffCardProps & Omit<HTMLProps<HTMLElement>, "as" | "height">, "ref"> & react583.RefAttributes<unknown>>;
/** @internal */
...
declare class DiffErrorBoundary extends Component<DiffErrorBoundaryProps, DiffErrorBoundaryState> {
  ...
  render(): string | number | bigint | boolean | react583.JSX.Element | Iterable<ReactNode> | Promise<string | number | bigint | boolean | Iterable<ReactNode> | react583.ReactElement<unknown, string | react583.JSXElementConstructor<any>> | react583.ReactPortal | null | undefined> | null | undefined;
}
/** @internal */
...
/** @internal */
declare function DiffFromTo(props: DiffFromToProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare function DiffTooltip(props: DiffTooltipProps | DiffTooltipWithAnnotationsProps): react583.JSX.Element;
...
declare function Event$1({
  event,
  showChangesBy
}: TimelineItemProps): react583.JSX.Element;
/** @internal */
...
declare function FieldChange(props: {
  ...
  hidden?: boolean;
  addParentWrapper?: boolean;
} & HTMLAttributes<HTMLDivElement>): react583.JSX.Element | null;
/** @internal */
type FromToProps = {
  align?: 'top' | 'center' | 'bottom';
  layout?: 'grid' | 'inline';
...
/** @internal */
declare const FromTo: react583.ForwardRefExoticComponent<Omit<FromToProps, "ref"> & react583.RefAttributes<HTMLDivElement>>;
/** @internal */
type FromToArrowDirection = 'down' | 'right';
/** @internal */
declare function FromToArrow(props: {
  direction?: FromToArrowDirection;
} & TextProps & Omit<HTMLProps<HTMLDivElement>, 'children' | 'ref'>): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare function MetaInfo(props: MetaInfoProps): react583.JSX.Element;
/** @internal */
declare function NoChanges(): react583.JSX.Element;
/** @internal */
declare const RevertChangesButton: react583.ForwardRefExoticComponent<Omit<ButtonProps$1, "tooltipProps"> & Omit<HTMLProps<HTMLButtonElement>, "ref"> & {
  changeCount: number;
} & react583.RefAttributes<HTMLButtonElement>>;
...
declare function RevertChangesConfirmDialog({
  ...
  changeCount,
  referenceElement
}: RevertChangesConfirmDialogProps): react583.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare function EditScheduleForm(props: PropsWithChildren<Props$2>): react583.JSX.Element;
/**
 * @internal
 */
...
declare function useScheduleAction(props: DocumentActionProps): {
  disabled: true;
  icon: react583.ForwardRefExoticComponent<Omit<react583.SVGProps<SVGSVGElement>, "ref"> & react583.RefAttributes<SVGSVGElement>>;
  label: string;
  title: react583.JSX.Element;
  dialog?: undefined;
  onHandle?: undefined;
} | {
  ...
  icon: react583.ForwardRefExoticComponent<Omit<react583.SVGProps<SVGSVGElement>, "ref"> & react583.RefAttributes<SVGSVGElement>>;
  onHandle: () => void;
  title: "" | react583.JSX.Element | null;
} | null;
...
/** @internal */
declare function GetHookCollectionState<Args, State>(props: GetHookCollectionStateProps<Args, State>): react583.JSX.Element;
/**
 * @hidden
 * @beta */
...
}: SingleDocReleaseProviderProps): react583.JSX.Element;
/**
 ...
 * @internal
 */
declare const formatRelativeLocale: (date: string | number | Date, baseDate: string | number | Date, options?: date_fns0.FormatRelativeOptions | undefined) => string;
/**
...
declare function DocumentStatus({
  ...
  versions,
  singleLine
}: DocumentStatusProps$1): react583.JSX.Element;
/**
 * @internal
 */
...
declare function DocumentStatusIndicator({
  ...
  published,
  versions
}: DocumentStatusProps): react583.JSX.Element;
/**
 * @internal
 */
...
declare function Hotkeys({
  ...
  keys: hotKeys,
  ...props
}: HotkeysProps$1): react583.JSX.Element;
/** @internal */
...
declare function InsufficientPermissionsMessage({
  currentUser,
  context
}: InsufficientPermissionsMessageProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function IntentButton(props: IntentLinkProps & ButtonProps$1 & Omit<HTMLProps<HTMLButtonElement>, 'ref' | 'size' | 'as'>): react583.JSX.Element;
...
declare function LoadingBlock({
  ...
  showText,
  title
}: LoadingTestProps): react583.JSX.Element;
...
/** @internal */
declare function PopoverDialog(props: PopoverDialogProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare const PreviewCard: react583.ForwardRefExoticComponent<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react583.RefAttributes<HTMLDivElement>>;
/**
 ...
 * @internal
 */
declare const ReferenceInputPreviewCard: styled_components_dist_types6.IStyledComponentBase<"web", styled_components4.FastOmit<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react583.RefAttributes<HTMLDivElement>, never>> & string & Omit<react583.ForwardRefExoticComponent<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react583.RefAttributes<HTMLDivElement>>, keyof react583.Component<any, {}, any>>;
/**
 ...
 * @hidden
 * @beta */
declare function CompactPreview(props: CompactPreviewProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DefaultPreview(props: DefaultPreviewProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DetailPreview(props: DetailPreviewProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function MediaPreview(props: MediaPreviewProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function BlockImagePreview(props: BlockImagePreviewProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
declare function BlockPreview(props: Omit<PreviewProps<'block'>, 'renderDefault'>): react583.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function InlinePreview(props: InlinePreviewProps): react583.JSX.Element;
 ...
 * @hidden
 * @beta */
declare function TemplatePreview(props: TemplatePreviewProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
...
declare function RelativeTime({
  time,
  ...options
}: RelativeTimeProps): react583.JSX.Element;
 ...
 */
declare function Resizable(props: ResizableProps & BoxProps & Omit<HTMLProps<HTMLDivElement>, 'as'>): react583.JSX.Element;
/**
 * @hidden
 * @beta */
...
/** @hidden @beta */
declare const StatusButton: react583.ForwardRefExoticComponent<(StatusButtonProps & Omit<HTMLProps<HTMLButtonElement>, "disabled" | "ref" | "size" | "title">) & react583.RefAttributes<HTMLButtonElement>>;
/** @internal */
...
/** @internal */
declare const TextWithTone: react583.ForwardRefExoticComponent<Omit<TextWithToneProps, "ref"> & react583.RefAttributes<HTMLDivElement>>;
/** @internal */
declare const TooltipOfDisabled: react583.ForwardRefExoticComponent<Omit<_sanity_ui17.TooltipProps, "arrow" | "padding" | "shadow"> & {
 ...
 */
declare const ImperativeToast: react583.ForwardRefExoticComponent<react583.RefAttributes<unknown>>;
/**
 ...
 * @beta
 */
declare const AvatarSkeleton: styled_components_dist_types6.IStyledComponentBase<"web", styled_components_dist_types6.Substitute<Omit<_sanity_ui17.SkeletonProps & react583.HTMLProps<HTMLDivElement>, "ref"> & react583.RefAttributes<HTMLDivElement>, AvatarSkeletonProps>> & string & Omit<react583.ForwardRefExoticComponent<Omit<_sanity_ui17.SkeletonProps & react583.HTMLProps<HTMLDivElement>, "ref"> & react583.RefAttributes<HTMLDivElement>>, keyof react583.Component<any, {}, any>>;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function UserAvatar(props: UserAvatarProps): react583.JSX.Element;
/**
 * @internal
...
/** @internal */
declare const FormCallbacksProvider: react583.NamedExoticComponent<FormCallbacksValue & {
  children: ReactNode;
}>;
/** @internal */
 ...
 * @alpha
 */
declare function FormBuilder(props: FormBuilderProps): react583.JSX.Element;
/**
 ...
 * @alpha This API might change.
 */
declare function FormProvider(props: FormProviderProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function StudioCrossDatasetReferenceInput(props: StudioCrossDatasetReferenceInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function StudioReferenceInput(props: StudioReferenceInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @hidden
 * @beta */
declare function StudioFileInput(props: FileInputProps): react583.JSX.Element;
/**
 * @hidden
 * @beta
 */
 ...
 * @hidden
 * @beta */
declare function StudioImageInput(props: ImageInputProps): react583.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 * */
declare const SanityDefaultPreview: react583.NamedExoticComponent<SanityDefaultPreviewProps>;
/**
 * @internal
 * @beta
 *
...
declare function getPreviewValueWithFallback({
  ...
  title: react583.JSX.Element;
  subtitle: react583.JSX.Element;
  media: () => react583.JSX.Element;
};
/** @internal */
...
/** @internal */
declare function emitOperation(operationName: keyof OperationsAPI, idPair: IdPair, typeName: string, extraArgs: any[]): void;
/**
 * @hidden
 * @beta */
...
declare function ResourceCacheProvider({
  children
}: ResourceCacheProviderProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare function DocumentPreviewPresence(props: DocumentPreviewPresenceProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare const FieldPresenceInner: react583.NamedExoticComponent<FieldPresenceInnerProps>;
/** @internal */
...
/** @internal */
declare function FieldPresence(props: FieldPresenceProps): react583.JSX.Element;
/**
 * @internal
 * @hidden
...
declare function PresenceOverlay({
  children,
  margins
}: PresenceOverlayProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare function PresenceScope(props: PresenceScopeProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare const FormField: react583.NamedExoticComponent<FormFieldProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref">>;
/** @internal */
...
/** @internal */
declare const FormFieldHeaderText: react583.NamedExoticComponent<FormFieldHeaderTextProps>;
/** @internal */
...
/** @internal */
declare const FormFieldSet: react583.ForwardRefExoticComponent<FormFieldSetProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & react583.RefAttributes<HTMLDivElement>>;
/** @internal */
...
declare function FormFieldStatus({
  ...
  maxAvatars,
  position
}: FieldStatusProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare function FormFieldValidationStatus(props: FormFieldValidationStatusProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare const FormInput: react583.NamedExoticComponent<(ArrayOfObjectsInputProps<{
  _key: string;
 ...
 * ```
 */
declare function useGetFormValue(): sanity__singletons3.GetFormValueContextValue;
/** @internal */
...
/** @internal */
declare const FieldActionMenu: react583.NamedExoticComponent<FieldActionMenuProps>;
...
/** @internal */
declare const FieldActionsProvider: react583.NamedExoticComponent<FieldActionsProviderProps>;
/** @internal */
 ...
 * @internal
 */
declare const FieldActionsResolver: react583.NamedExoticComponent<FieldActionsProps>;
/** @internal */
declare function useFieldActions(): FieldActionsContextValue;
/** @internal */
declare const HoveredFieldProvider: react583.NamedExoticComponent<{
  children?: react583.ReactNode;
}>;
/** @internal */
 ...
 * @hidden
 * @beta */
declare function ArrayOfObjectsFunctions<Item extends ObjectItem, TSchemaType extends ArraySchemaType>(props: ArrayInputFunctionsProps<Item, TSchemaType>): react583.JSX.Element | null;
/**
 *
 * @hidden
 * @beta
 */
declare function ArrayOfObjectsInput(props: ArrayOfObjectsInputProps): react583.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 */
declare function VirtualizerScrollInstanceProvider(props: VirtualizerScrollInstanceProviderProps): react583.JSX.Element;
/**
 * @hidden
 ...
 * @beta
 */
declare function ArrayOfObjectOptionsInput(props: ArrayOfObjectsInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function ArrayOfOptionsInput(props: ArrayOfObjectsInputProps | ArrayOfPrimitivesInputProps): react583.JSX.Element;
/**
 ...
 * @beta
 */
declare function ArrayOfPrimitiveOptionsInput(props: ArrayOfPrimitivesInputProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
declare function ArrayOfPrimitivesFunctions<MemberType extends string | boolean | number, SchemaType extends ArraySchemaType>(props: ArrayInputFunctionsProps<MemberType, SchemaType>): react583.JSX.Element | null;
...
declare class ArrayOfPrimitivesInput extends PureComponent<ArrayOfPrimitivesInputProps, State> {
  ...
  getSnapshotBeforeUpdate(prevProps: ArrayOfPrimitivesInputProps): {
    prevFocusedIndex: _sanity_types44.PathSegment;
    restoreSelection: {
      text: string;
      start: number | null;
      end: number | null;
  ...
  renderArrayItem: (props: Omit<PrimitiveItemProps, "renderDefault">) => react583.JSX.Element;
  render(): react583.JSX.Element;
}
/**
 ...
 * @beta
 */
declare function UniversalArrayInput(props: ArrayOfObjectsInputProps | ArrayOfPrimitivesInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function BooleanInput(props: BooleanInputProps): react583.JSX.Element;
/**
 ...
 * @hidden
 * @beta */
declare function DateInput(props: DateInputProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DateTimeInput(props: DateTimeInputProps): react583.JSX.Element;
 ...
 * @beta
 */
declare function EmailInput(props: EmailInputProps): react583.JSX.Element;
/**
 * @hidden
 * @beta
 */
 ...
 * @beta
 */
declare function NumberInput(props: NumberInputProps): react583.JSX.Element;
/**
 * @hidden
 * @beta */
declare const ObjectInput: react583.NamedExoticComponent<ObjectInputProps<Record<string, any>, _sanity_types44.ObjectSchemaType>>;
/** @internal */
...
}, "ref"> & react583.RefAttributes<HTMLInputElement>>;
/**
 *
 * @hidden
 * @beta
 */
declare function SelectInput(props: StringInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function SlugInput(props: SlugInputProps): react583.JSX.Element;
/**
 * @hidden
 * @beta
 */
declare function StringInput(props: StringInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TagsArrayInput(props: TagsArrayInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TelephoneInput(props: TelephoneInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TextInput(props: TextInputProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function UrlInput(props: UrlInputProps): react583.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare function ArrayOfObjectsInputMember(props: ArrayOfObjectsMemberProps): react583.JSX.Element | null;
/** @internal */
 ...
 * @internal
 */
declare function ArrayOfObjectsInputMembers(props: ArrayOfObjectsInputMembersProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function ArrayOfObjectsItem(props: MemberItemProps): react583.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function ArrayOfPrimitivesItem(props: PrimitiveMemberItemProps): react583.JSX.Element;
/** @internal */
...
/** @internal */
declare const MemberField: react583.NamedExoticComponent<MemberFieldProps>;
/** @internal */
declare function MemberFieldError(props: {
  member: FieldError;
}): react583.JSX.Element;
/** @internal */
declare const MemberFieldSet: react583.NamedExoticComponent<{
...
/** @internal */
declare const ObjectInputMember: react583.NamedExoticComponent<ObjectInputMemberProps>;
/** @internal */
 ...
 * @internal
 */
declare function ObjectInputMembers(props: ObjectMembersProps): react583.JSX.Element;
/**
 ...
 * @hidden
 * @beta */
declare const TransformPatches: react583.NamedExoticComponent<{
 ...
 * @internal
 */
declare function createDefaultIcon(title: string, subtitle: string): react583.JSX.Element;
/**
 * @hidden
 * @beta */
...
export { MissingConfigFile as $, CommandListGetItemDisabledCallback as $C, DraftsModelDocumentAvailability as $S, StudioLogo as $_, HistoryStore as $a, resolveInitialValue as $b, ObjectMember as $c, CardinalityOneRelease as $d, DocumentActionModalDialogProps as $f, StudioLayout as $g, CreateLinkedActionsProps as $h, grantsPermissionOn as $i, ToastParams$1 as $l, StringSegmentUnchanged$1 as $m, UniversalArrayInput as $n, ArrayFieldProps as $o, DiffTooltipWithAnnotationsProps as $p, Location as $r, FileInputProps as $s, MutationPatch as $t, DocumentStatus as $u, MatchWorkspaceOptions as $v, WelcomeEvent as $x, validateDocument as $y, ComposableOption as A, createPublishedFrom as AC, ReporterHook as AS, FormIncPatch as A_, InitialValueErrorMsg as Aa, LocalesBundlesOption as Ab, FormCallbacksProvider as Ac, useUnique as Ad, DEFAULT_STUDIO_CLIENT_OPTIONS as Af, CommentInput as Ag, isUnscheduleDocumentVersionEvent as Ah, ProjectData as Ai, PatchMsg as Al, ArrayItemMetadata as Am, StringInput as An, unstable_useObserveDocument as Ao, isAddedItemDiff as Ap, FormFieldValidationInfo as Ar, RenderItemCallback as As, DocumentInspectorUseMenuItemProps as At, PortableTextPreviewLayoutKey as Au, SearchSort as Av, LoginComponentProps as Aw, useGlobalCopyPasteElementHandler as Ax, CommentMessage as Ay, DocumentBadgesContext as B, isPublishedId as BC, useIsReleaseActive as BS, PatchArg as B_, operationEvents as Ba, useUserListWithPermissions as Bb, useFormState as Bc, truncateString as Bd, DocumentBadgeComponent as Bf, WorkspaceProvider as Bg, UserColorHue as Bh, Session as Bi, set as Bl, DiffProps as Bm, ObjectInput as Bn, isNumberInputProps as Bo, NoChanges as Bp, FormField as Br, BlockListItemProps as Bs, DocumentFieldActionNode as Bt, LoadingBlock as Bu, ColorSchemeProviderProps as Bv, DocumentIdStack as Bx, CommentThreadItem as By, ActionComponent as C, DRAFTS_FOLDER as CC, TrackedChange as CS, CopyPasteContextType as C_, QueryParams$1 as Ca, LocaleNestedResource as Cb, defaultRenderPreview as Cc, ReleaseDocument$1 as Cd, useDocumentPreviewValues as Cf, useComments as Cg, isCreateLiveDocumentEvent as Ch, usePresenceStore as Ci, UndeclaredMembersError as Cl, getAnnotationAtPath as Cm, UrlInputProps as Cn, createObservableBufferedDocument as Co, normalizeKeySegment as Cp, FormValueProvider as Cr, StringInputProps as Cs, ReleaseActionProps as Ct, DetailPreviewProps as Cu, ValuelessSearchOperatorParams as Cv, MockAuthStoreOptions as Cw, UseNumberFormatOptions as Cx, CommentBaseCreatePayload as Cy, AsyncConfigPropertyReducer as D, VERSION_FOLDER as DC, useTrackerStoreReporter as DS, PatchEvent as D_, listenQuery as Da, LocaleResourceRecord as Db, ReferenceInputOptionsProvider as Dc, useNavigateToCanvasDoc as Dd, MentionUserContextValue as Df, COMMENTS_INSPECTOR_NAME as Dg, isPublishDocumentVersionEvent as Dh, useProjectDatasets as Di, resolveConditionalProperty as Dl, Annotation as Dm, TelephoneInputProps as Dn, getPreviewPaths as Do, stringToPath as Dp, FormInputRelativePathArg as Dr, RenderBlockCallback as Ds, DocumentInspectorComponent as Dt, CompactPreviewProps as Du, getSearchableTypes as Dv, createAuthStore as Dw, UseListFormatOptions as Dx, CommentFieldCreatePayload as Dy, AsyncComposableOption as E, SystemBundle as EC, useTrackerStore as ES, SanityClipboardItem as E_, ListenQueryParams as Ea, LocaleResourceKey as Eb, ReferenceInputOptions as Ec, getDocumentIdForCanvasLink as Ed, TasksNavigationContextValue as Ef, isTextSelectionComment as Eg, isEditDocumentVersionEvent as Eh, useUserStore as Ei, ALL_FIELDS_GROUP as El, visitDiff as Em, TelephoneInput as En, getPreviewStateObservable as Eo, pathsAreEqual as Ep, FormInputAbsolutePathArg as Er, RenderArrayOfPrimitivesItemCallback as Es, DocumentInspector as Et, CompactPreview as Eu, isPerspectiveRaw as Ev, _createAuthStore as Ew, useManageFavorite as Ex, CommentDocument as Ey, DecisionParametersConfig as F, getVersionFromId as FC, ChangeIndicatorProps as FS, FormPatchJSONValue as F_, validation$1 as Fa, StudioLocaleResourceKeys as Fb, ExpandPathOperation as Fc, LoadedState as Fd, useSingleDocRelease as Ff, UpsellData as Fg, createUserColorManager as Fh, SESSION_ID as Fi, dec as Fl, ChunkType as Fm, CreateButton as Fn, Preview as Fo, noop as Fp, FormFieldStatus as Fr, ObjectItem as Fs, DocumentFieldAction as Ft, PreviewCard as Fu, SearchHeader as Fv, EditPortal as Fw, useFilteredReleases as Fx, CommentReactionOption as Fy, DocumentLanguageFilterComponent as G, removeDupes as GC, ObserveForPreviewFn as GS, ActiveToolLayoutProps as G_, OperationsAPI as Ga, useTools as Gb, ArrayOfObjectsItemMember as Gc, joinPath as Gd, HookCollectionActionHook as Gf, UpsellDialogDismissed as Gg, getSanityCreateLinkMetadata as Gh, createUserStore as Gi, WithReferringDocuments as Gl, ItemDiff$1 as Gm, EmailInputProps as Gn, FormBuilderCustomMarkersComponent as Go, FromToArrowDirection as Gp, PresenceOverlayProps as Gr, ArrayInputCopyEvent as Gs, DocumentFieldActionsResolverContext as Gt, HotkeysProps$1 as Gu, useColorSchemeValue as Gv, InitialSnapshotEvent as Gx, CommentsType as Gy, DocumentCommentsEnabledContext as H, isSystemBundleName as HC, useDocumentVersions as HS, ToolLinkProps as H_, Operation as Ha, UnitFormatter as Hb, StateTree as Hc, supportsTouch as Hd, DocumentBadgeProps as Hf, useWorkspace as Hg, UserId as Hh, UserSessionPair as Hi, unset as Hl, FieldOperationsAPI as Hm, AssetAccessPolicy as Hn, isObjectItemProps as Ho, MetaInfoProps as Hp, PresenceScope as Hr, BlockStyleProps as Hs, DocumentFieldActionStatus as Ht, InsufficientPermissionsMessage as Hu, useColorSchemeInternalValue as Hv, EditStateFor as Hx, CommentUpdatePayload as Hy, DefaultPluginsWorkspaceOptions as I, getVersionId as IC, ChangeFieldWrapper as IS, FormPatchOrigin as I_, remoteSnapshots as Ia, Rule as Ib, SetActiveGroupOperation as Ic, LoadingState as Id, getSchemaTypeTitle as If, WorkspaceLoaderBoundary as Ig, useUserColor as Ih, createPresenceStore as Ii, diffMatchPatch as Il, Diff$1 as Im, CreateReferenceOption as In, isArrayOfBlocksInputProps as Io, DocumentChangeContextInstance as Ip, FormFieldSet as Ir, ObjectItemProps as Is, DocumentFieldActionDivider as It, PreviewCardContextValue as Iu, Filters as Iv, createSanityMediaLibraryFileSource as Iw, useFeatureEnabled as Ix, CommentReactionShortNames as Iy, DocumentLayoutProps as J, DocumentVariantType as JC, AvailabilityReason as JS, NavbarAction as J_, useTimelineSelector as Ja, useTemplates as Jb, ArrayOfPrimitivesMember as Jc, _isType as Jd, DocumentActionConfirmDialogProps as Jf, UpsellDialogViewed as Jg, isSanityCreateLinkedDocument as Jh, getTemplatePermissions as Ji, UserAvatarProps as Jl, ObjectDiff$1 as Jm, DateTimeInputProps as Jn, FormBuilderMarkersComponent as Jo, FieldChange as Jp, FieldPresenceInnerProps as Jr, UploadEvent as Js, CookielessCompatibleLoginMethod as Jt, ErrorWithId as Ju, StudioThemeColorSchemeKey as Jv, getPairListener as Jx, CommentsAuthoringPathContextValue as Jy, DocumentLanguageFilterContext as K, systemBundles as KC, createDocumentPreviewStore as KS, LayoutProps as K_, DocumentVersionSnapshots as Ka, TimeAgoOpts as Kb, ArrayOfObjectsMember as Kc, _isCustomDocumentTypeDefinition as Kd, useScheduleAction as Kf, UpsellDialogLearnMoreCtaClicked as Kg, isSanityCreateExcludedType as Kh, TemplatePermissionsOptions as Ki, AvatarSkeleton as Kl, NullDiff$1 as Km, getCalendarLabels as Kn, FormBuilderFilterFieldFn as Ko, FromTo as Kp, FieldPresence as Kr, ArrayInputInsertEvent as Ks, AuthConfig as Kt, serializeError as Ku, StudioColorScheme as Kv, LatencyReportEvent as Kx, CommentsUIMode as Ky, DocumentActionsContext as L, idMatchesPerspective as LC, sortReleases as LS, FormSetIfMissingPatch as L_, OperationError as La, UserListWithPermissionsHookValue as Lb, getExpandOperations as Lc, asLoadable as Ld, createSchema as Lf, useWorkspaceLoader as Lg, useUserColorManager as Lh, DocumentPresence as Li, inc as Ll, DiffComponent as Lm, PortableTextInput as Ln, isArrayOfObjectsInputProps as Lo, ValueError as Lp, FormFieldSetProps as Lr, PrimitiveItemProps as Ls, DocumentFieldActionGroup as Lt, ReferenceInputPreviewCard as Lu, ColorSchemeCustomProvider as Lv, createSanityMediaLibraryImageSource as Lw, useEditState as Lx, CommentStatus as Ly, ConfigContext$1 as M, getDraftId as MC, ChangeConnectorRootProps as MS, FormInsertPatchPosition as M_, InitialValueMsg as Ma, StaticLocaleResourceBundle as Mb, useFormCallbacks as Mc, userHasRole as Md, useScheduledDraftDocument as Mf, CommentInputProps as Mg, UserColorManagerProvider as Mh, ProjectGrants as Mi, RebasePatchMsg as Ml, ChangeNode as Mm, SlugInputProps as Mn, SanityDefaultPreview as Mo, isGroupChange as Mp, FormFieldValidationStatus as Mr, RenderPreviewCallbackProps as Ms, initialDocumentFieldActions as Mt, PreviewLayoutKey as Mu, SearchResultItemPreview as Mv, KeyValueStore as Mw, FormattedDuration as Mx, CommentPath as My, ConfigPropertyReducer as N, getIdPair as NC, ConnectorContextValue as NS, FormPatch as N_, InitialValueState as Na, TFunction$1 as Nb, ExpandFieldSetOperation as Nc, ErrorState as Nd, usePausedScheduledDraft as Nf, CommentsList as Ng, UserColorManagerProviderProps as Nh, ProjectStore as Ni, createPatchChannel as Nl, ChangeTitlePath as Nm, SelectInput as Nn, SanityDefaultPreviewProps as No, isRemovedItemDiff as Np, FormFieldValidationStatusProps as Nr, BaseItemProps as Ns, documentFieldActionsReducer as Nt, PreviewMediaDimensions as Nu, SearchPopover as Nv, KeyValueStoreValue as Nw, UseFormattedDurationOptions as Nx, CommentPostPayload as Ny, BaseActionDescription as O, collate as OC, IsEqualFunction as OS, FormDecPatch as O_, InitialValueOptions as Oa, LocaleSource as Ob, TemplateOption as Oc, useCanvasCompanionDoc as Od, IsLastPaneProvider as Of, CommentInlineHighlightSpan as Og, isScheduleDocumentVersionEvent as Oh, useProject as Oi, MutationPatchMsg as Ol, AnnotationDetails as Om, TagsArrayInput as On, unstable_useValuePreview as Oo, resolveDiffComponent as Op, FormFieldValidation as Or, RenderFieldCallback as Os, DocumentInspectorMenuItem as Ot, GeneralDocumentListLayoutKey as Ou, SearchFactoryOptions as Ov, AuthState as Ow, useListFormat as Ox, CommentIntentGetter as Oy, DECISION_PARAMETERS_SCHEMA as P, getPublishedId as PC, ChangeIndicator as PS, FormPatchBase as P_, InitialValueSuccessMsg as Pa, ValidationLocaleResourceKeys as Pb, ExpandOperation as Pc, LoadableState as Pd, SingleDocReleaseProvider as Pf, CommentsUpsellContextValue as Pg, UserColorManagerOptions as Ph, PresenceStore as Pi, SANITY_PATCH_TYPE as Pl, Chunk as Pm, ReferenceAutocomplete as Pn, PreviewLoader as Po, isUnchangedDiff as Pp, FieldStatusProps as Pr, ItemProps as Ps, defineDocumentFieldAction as Pt, PreviewProps as Pu, SearchPopoverProps as Pv, EnhancedObjectDialog as Pw, useFormattedDuration as Px, CommentReactionItem as Py, MediaLibraryConfig as Q, CommandListElementType as QC, DraftsModelDocument as QS, ToolMenuProps as Q_, DocumentRevision as Qa, resolveInitialObjectValue as Qb, FieldsetRenderMembersCallback as Qc, resizeObserver as Qd, DocumentActionGroup as Qf, NavbarContextValue as Qg, CreateLinkMetadata as Qh, createGrantsStore as Qi, ImperativeToast as Ql, StringSegmentChanged$1 as Qm, BooleanInput as Qn, RenderCustomMarkers as Qo, DiffTooltipProps as Qp, FormNodePresence as Qr, StudioImageInput as Qs, encodePath as Qt, CapabilityGate as Qu, useActiveWorkspace as Qv, ReconnectEvent as Qx, ValidateDocumentOptions as Qy, DocumentActionsResolver as R, isDraft as RC, useVersionOperations as RS, FormSetPatch as R_, OperationSuccess as Ra, UserListWithPermissionsOptions as Rb, FormState as Rc, useLoadable as Rd, SchedulesContext as Rf, ErrorMessage as Rg, HexColor as Rh, GlobalPresence as Ri, insert as Rl, DiffComponentOptions as Rm, PortableTextMemberItem as Rn, isArrayOfPrimitivesInputProps as Ro, RevertChangesConfirmDialog as Rp, FormFieldHeaderText as Rr, BlockAnnotationProps as Rs, DocumentFieldActionHook as Rt, usePreviewCard as Ru, ColorSchemeLocalStorageProvider as Rv, useDocumentOperationEvent as Rx, CommentTaskCreatePayload as Ry, useMiddlewareComponents as S, CollatedHit as SC, TrackedArea as SS, CopyOptions as S_, DocumentStoreOptions as Sa, LocaleDefinition as Sb, defaultRenderItem as Sc, DEFAULT_DECORATORS as Sd, LegacyThemeTints as Sf, CommentsEnabledContextValue as Sg, isCreateDocumentVersionEvent as Sh, useKeyValueStore as Si, TypeAnnotationMismatchError as Sl, DiffVisitor as Sm, UrlInput as Sn, CommitRequest as So, normalizeIndexTupleSegment as Sp, FormValueContextValue as Sr, PrimitiveInputProps as Ss, ReleaseActionDescription as St, DetailPreview as Su, ValuelessSearchOperatorBuilder as Sv, getProviderTitle as Sw, useProjectId as Sx, CommentsProvider as Sy, AssetSourceResolver as T, PublishedId as TC, TrackerContextStore as TS, PasteOptions as T_, ListenQueryOptions as Ta, LocaleResourceBundle as Tb, EditReferenceOptions as Tc, useDocumentLimitsUpsellContext as Td, TasksContextValue as Tf, hasCommentMessageValue as Tg, isDeleteDocumentVersionEvent as Th, useRenderingContextStore as Ti, ProvenanceDiffAnnotation as Tl, getDiffAtPath as Tm, TextInputProps as Tn, getPreviewValueWithFallback as To, pathToString as Tp, FormInput as Tr, RenderArrayOfObjectsItemCallback as Ts, FormComponents as Tt, DefaultPreviewProps as Tu, createSearch as Tv, AuthStoreOptions as Tw, UseManageFavoriteProps as Tx, CommentCreatePayload as Ty, DocumentInspectorContext as U, isVersionId as UC, DocumentPreviewStore as US, StudioToolMenu as U_, OperationArgs as Ua, UseUnitFormatterOptions as Ub, FieldsetMembers as Uc, escapeField as Ud, GetHookCollectionState as Uf, InterpolationProp as Ug, isDev as Uh, UserStore as Ui, ZIndexProvider as Ul, FromToIndex as Um, ImageUrlBuilder$1 as Un, isStringInputProps as Uo, GroupChange as Up, PresenceScopeProps as Ur, MarkdownConfig as Us, DocumentFieldActionTone as Ut, InsufficientPermissionsMessageProps as Uu, useColorSchemeOptions as Uv, editState$1 as Ux, CommentsListBreadcrumbItem as Uy, DocumentBadgesResolver as V, isSystemBundle as VC, useDocumentVersionTypeSortedList as VS, ToolLink as V_, MapDocument as Va, FormattableMeasurementUnit as Vb, setAtPath as Vc, uncaughtErrorHandler as Vd, DocumentBadgeDescription as Vf, WorkspaceProviderProps as Vg, UserColorManager as Vh, Status as Vi, setIfMissing as Vl, FieldChangeNode as Vm, NumberInput as Vn, isObjectInputProps as Vo, MetaInfo as Vp, FormFieldProps as Vr, BlockProps as Vs, DocumentFieldActionProps as Vt, IntentButton as Vu, useColorScheme as Vv, useDocumentIdStack as Vx, CommentUpdateOperationOptions as Vy, DocumentInspectorsResolver as W, newDraftFrom as WC, DocumentPreviewStoreOptions as WS, StudioNavbar as W_, OperationImpl as Wa, useUnitFormatter as Wb, FieldsetState as Wc, fieldNeedsEscape as Wd, GetHookCollectionStateProps as Wf, UpsellDescriptionSerializer as Wg, isProd as Wh, UserStoreOptions as Wi, useZIndex as Wl, GroupChangeNode as Wm, EmailInput as Wn, ArrayInputFunctionsProps as Wo, FromToArrow as Wp, PresenceOverlay as Wr, PortableTextPluginsProps as Ws, DocumentFieldActionsResolver as Wt, Hotkeys as Wu, useColorSchemeSetValue as Wv, DocumentStoreExtraOptions as Wx, CommentsTextSelectionItem as Wy, FormBuilderComponentResolverContext as X, ContextMenuButton as XC, DocumentAvailability as XS, StudioComponents as X_, TimelineStore as Xa, Serializeable as Xb, FieldMember as Xc, SharedResizeObserver as Xd, DocumentActionDescription as Xf, StudioProvider as Xg, SanityCreateConfigContextValue as Xh, useTemplatePermissionsFromHookFactory as Xi, ZIndexContextValueKey as Xl, StringDiff$1 as Xm, DateInputProps as Xn, RenderBlockActionsCallback as Xo, Event$1 as Xp, FieldPresenceWithOverlay as Xr, useEnhancedObjectDialog as Xs, TransformPatches as Xt, ErrorActionsProps as Xu, AddonDatasetContextValue as Xv, MutationEvent as Xx, useWorkspaceSchemaId as Xy, DocumentPluginOptions as Y, getDocumentVariantType as YC, AvailabilityResponse as YS, NavbarProps as Y_, TimelineState as Ya, DEFAULT_MAX_RECURSION_DEPTH as Yb, DecorationMember as Yc, createSWR as Yd, DocumentActionCustomDialogComponentProps as Yf, UpsellDialogViewedInfo as Yg, isSanityCreateStartCompatibleDoc as Yh, useTemplatePermissions as Yi, LegacyLayerProvider as Yl, ReferenceDiff as Ym, DateInput as Yn, PortableTextMarker as Yo, FallbackDiff as Yp, FieldPresenceProps as Yr, EnhancedObjectDialogContextValue as Ys, LoginMethod as Yt, ErrorActions as Yu, useAddonDataset as Yv, IdPair as Yx, CommentsAuthoringPathProvider as Yy, GroupableActionDescription as Z, CommandList as ZC, DocumentStackAvailability as ZS, StudioComponentsPluginOptions as Z_, useTimelineStore as Za, isBuilder as Zb, FieldSetMember as Zc, createSharedResizeObserver as Zd, DocumentActionDialogProps as Zf, StudioProviderProps as Zg, useSanityCreateConfig as Zh, GrantsStoreOptions as Zi, ZIndexContextValue as Zl, StringDiffSegment as Zm, CrossDatasetReferencePreview as Zn, RenderBlockActionsProps as Zo, DiffTooltip as Zp, FieldPresenceData as Zr, ImageInputProps as Zs, decodePath as Zt, DocumentStatusIndicator as Zu, AddonDatasetProvider as Zv, PendingMutationsEvent as Zx, useValidationStatus as Zy, createDefaultIcon as _, PerspectiveStack as _C, CommentDeleteDialog as _S, StudioManifest as __, isNewDocument as _a, LocaleProvider as _b, defaultRenderAnnotation as _c, VersionInfoDocumentStub as _d, createHookFromObservableFactory as _f, buildCommentRangeDecorations as _g, PublishDocumentVersionEvent as _h, useConnectionStatusStore as _i, FieldError as _l, ChangeList as _m, MemberItemProps as _n, WithVersion as _o, getItemKey as _p, FieldActionsProvider as _r, NumberInputProps as _s, Tool as _t, BlockPreview as _u, SearchOperatorBuilder as _v, RetryingStatus as _w, RelativeTimeOptions as _x, CommentsSelectedPathContextValue as _y, resolveSchemaTypes as a, ObservePathsFn as aC, MutationPayload as aS, StudioAnnouncementsCard as a_, getDocumentPairPermissions as aa, UseTranslationOptions as ab, UploadProgressEvent as ac, RELEASES_STUDIO_CLIENT_OPTIONS as ad, isString as af, ScrollEventHandler as ag, useEvents as ah, Size as ai, DocumentFormNode as al, DiffFromToProps as am, ObjectMembers as an, TimelineControllerOptions as ao, SchedulesContextValue as ap, VirtualizerScrollInstanceProvider as ar, NumberFieldProps as as, PluginOptions as at, useRovingFocus as au, SearchProvider as av, CommandListRenderItemCallback as aw, Template as ax, ValidateWorkspaceOptions as ay, ConfigPropertyError as b, SelectedPerspective as bC, useChangeIndicatorsReporter as bS, useCopyPaste as b_, useDocumentType as ba, Locale as bb, defaultRenderInlineBlock as bc, RELEASES_INTENT as bd, buildLegacyTheme as bf, CommentsOnboardingContextValue as bg, UnscheduleDocumentVersionEvent as bh, useGrantsStore as bi, MissingKeysError as bl, useAnnotationColor as bm, ArrayOfObjectsInputMember as bn, BufferedDocumentWrapper as bo, isEmptyObject as bp, GetFormValueProvider as br, PortableTextInputProps as bs, WorkspaceSummary as bt, MediaPreview as bu, SearchOperatorParams as bv, isAuthStore as bw, useReferringDocuments as bx, CommentsIntentProviderProps as by, createWorkspaceFromConfig as c, Previewable as cC, useDialogStack as cS, SourceProvider as c_, DocumentValuePermission as ca, useCurrentLocale as cb, UploaderResolver as cc, getReleaseTone as cd, isArray as cf, useOnScroll as cg, CreateLiveDocumentEvent as ch, useCurrentUser as ci, NodeDiffProps as cl, DiffErrorBoundaryProps as cm, ObjectInputMemberProps as cn, TimelineOptions as co, usePerspective as cp, ArrayOfObjectsInput as cr, StringFieldProps as cs, ResolveProductionUrlContext as ct, Resizable as cu, defineSearchFilter as cv, CorsOriginError as cw, TemplateItem as cx, validateWorkspaces as cy, flattenConfig as d, VersionInlineBadge as dC, useDataset as dS, renderStudio as d_, GrantsStore as da, I18nNode as db, StudioCrossDatasetReferenceInput as dc, PUBLISHED as dd, getErrorMessage as df, CommonProps as dg, DocumentGroupEvent as dh, ResourceCacheProvider as di, ObjectFormNode as dl, DiffCardProps as dm, MemberField as dn, Transaction as do, PerspectiveProvider as dp, FormBuilderContextValue as dr, ArrayOfPrimitivesInputProps as ds, SchemaPluginOptions as dt, LinearProgress as du, operatorDefinitions as dv, ConnectedStatus as dw, TypeTarget as dx, getWorkspaceIdentifier as dy, FieldName as eC, CommitFunction as eS, StudioLayoutComponent as e_, DocumentValuePermissionsOptions as ea, Translate as eb, StudioFileInput as ec, formatRelativeLocalePublishDate as ed, isCardinalityOnePerspective as ef, CreateLinkedDocumentBannerContentProps as eg, TypeChangeDiff$1 as eh, Position as ei, ArrayOfObjectsFormNode as el, DiffString as em, fromMutationPatches as en, HistoryStoreOptions as eo, DocumentActionPopoverDialogProps as ep, ArrayOfPrimitivesInput as er, ArrayOfPrimitivesFieldProps as es, NewDocumentCreationContext as et, TooltipOfDisabled as eu, SearchDialog as ev, CommandListGetItemKeyCallback as ew, resolveInitialValueForType as ex, MatchWorkspaceResult as ey, PluginFactory as f, getVersionInlineBadge as fC, ConnectionState as fS, uploadSchema as f_, PermissionCheckResult as fa, useI18nText as fb, StudioCrossDatasetReferenceInputProps as fc, useReleasesIds as fd, formatRelativeLocale as ff, AutoCollapseMenu as fg, DocumentVersionEventType as fh, ResourceCacheProviderProps as fi, ObjectRenderMembersCallback as fl, TIMELINE_ITEM_I18N_KEY_MAPPING as fm, MemberFieldProps as fn, DocumentVersion as fo, ReleasesNav as fp, useHoveredField as fr, BaseInputProps as fs, SingleWorkspace as ft, CircularProgress as fu, I18nSearchOperatorDescriptionKey as fv, ConnectingStatus as fw, SyncState as fx, WorkspaceLike as fy, defineConfig as g, PerspectiveContextValue as gC, CommentDisabledIcon as gS, ManifestWorkspaceInput as g_, selectUpstreamVersion as ga, removeUndefinedLocaleResources as gb, FormBuilderProps as gc, useActiveReleases as gd, ReactHook as gf, buildRangeDecorationSelectionsFromComments as gg, HistoryClearedEvent as gh, useComlinkStore as gi, DuplicateKeysError as gl, ChangeResolverProps as gm, ArrayOfObjectsItem as gn, RemoteSnapshotVersionEvent as go, findIndex as gp, FieldActionsResolver as gr, InputProps as gs, TemplateResolver as gt, InlinePreviewProps as gu, SearchOperatorBase as gv, ErrorStatus as gw, useReviewChanges as gx, CommentsSelectedPath as gy, createConfig as h, VersionChip as hC, useClient as hS, generateStudioManifest as h_, useInitialValueResolverContext as ha, defineLocalesResources as hb, FormBuilder as hc, useArchivedReleases as hd, LoadingTuple as hf, buildTextSelectionFromFragment as hg, EventsStoreRevision as hh, useDocumentPresence as hi, ArrayItemError as hl, ChangeResolver as hm, PrimitiveMemberItemProps as hn, Pair as ho, FIXME as hp, FieldActionsProps as hr, InputOnSelectFileFunctionProps as hs, SourceOptions as ht, InlinePreview as hu, OperatorInputComponentProps as hv, ConnectionStatusStoreOptions as hw, useSchema as hx, RouterHistory as hy, SchemaError as i, ObserveDocumentTypeFromIdFn as iC, DocumentRemoteMutationEvent as iS, StudioAnnouncementsContextValue as i_, DocumentPermission as ia, usEnglishLocale as ib, UploadOptions as ic, isReleaseScheduledOrScheduling as id, isTruthy as if, ScrollContextValue as ig, EventsProvider as ih, ReportedRegionWithRect as ii, ComputeDiff as il, DiffFromTo as im, ObjectInputMembers as in, TimelineController as io, isSanityDefinedAction as ip, ArrayOfObjectOptionsInput as ir, FieldProps as is, Plugin as it, StatusButtonProps as iu, useSearchState as iv, CommandListProps as iw, InitialValueTemplateItem as ix, WorkspacesContextValue as iy, Config as j, documentIdEquals as jC, ChangeConnectorRoot as jS, FormInsertPatch as j_, InitialValueLoadingMsg as ja, LocalesOption as jb, FormCallbacksValue as jc, useThrottledCallback as jd, useScheduledDraftsEnabled as jf, CommentInputHandle as jg, isUpdateLiveDocumentEvent as jh, ProjectDatasetData as ji, PatchMsgSubscriber as jl, BooleanDiff$1 as jm, SlugInput as jn, useUnstableObserveDocument as jo, isFieldChange as jp, FormFieldValidationWarning as jr, RenderPreviewCallback as js, defineDocumentInspector as jt, PreviewComponent as ju, SearchTerms as jv, createKeyValueStore as jw, FormDocumentValue as jx, CommentOperations as jy, BetaFeatures as k, createDraftFrom as kC, Reported as kS, FormDiffMatchPatch as k_, getInitialValueStream as ka, LocaleWeekInfo as kb, useReferenceInputOptions as kc, SANITY_VERSION as kd, TasksEnabledContextValue as kf, CommentInputContextValue as kg, isUnpublishDocumentEvent as kh, createProjectStore as ki, PatchChannel as kl, ArrayDiff$1 as km, TagsArrayInputProps as kn, useValuePreview as ko, useDocumentChange as kp, FormFieldValidationError as kr, RenderInputCallback as ks, DocumentInspectorProps as kt, GeneralPreviewLayoutKey as ku, SearchOptions as kv, AuthStore as kw, GlobalCopyPasteElementHandler as kx, CommentListBreadcrumbs as ky, resolveConfig as l, PreviewableType as lC, UseDateTimeFormatOptions as lS, SourceProviderProps as l_, EvaluationParams as la, useLocale as lb, StudioReferenceInput as lc, getReleaseIdFromReleaseDocumentId as ld, globalScope as lf, CollapseMenuButton as lg, DeleteDocumentGroupEvent as lh, useUser as li, NumberFormNode as ll, DiffErrorBoundaryState as lm, MemberFieldSet as ln, CombinedDocument as lo, useGetDefaultPerspective as lp, ArrayOfObjectsFunctions as lr, ArrayOfObjectsInputProps as ls, SanityFormConfig as lt, RelativeTime as lu, defineSearchFilterOperators as lv, CorsOriginErrorOptions as lw, TemplateParameter as lx, useWorkspaces as ly, definePlugin as m, ReleaseAvatarIcon as mC, useConditionalToast as mS, GenerateStudioManifestOptions as m_, useInitialValue as ma, defineLocaleResourceBundle as mb, FormProviderProps as mc, useDocumentVersionInfo as md, EMPTY_OBJECT as mf, CollapseMenuProps as mg, EventsStore as mh, useGlobalPresence as mi, StringFormNode as ml, ChangesError as mm, ArrayOfPrimitivesItem as mn, MutationResult as mo, isPerspectiveWriteable as mp, useFieldActions as mr, ComplexElementProps as ms, SourceClientOptions as mt, TemplatePreviewProps as mu, OperatorButtonValueComponentProps as mv, ConnectionStatusStore as mw, useStudioUrl as mx, ActiveWorkspaceMatcherProps as my, getConfigContextFromSource as n, InvalidationChannelEvent as nC, DocumentMutationEvent as nS, isValidAnnouncementRole as n_, useDocumentValuePermissions as na, TranslationProps as nb, FileLike as nc, isDraftPerspective as nd, isPausedCardinalityOneRelease as nf, AppIdCache as ng, getValueError as nh, Rect as ni, BaseFormNode as nl, DiffInspectWrapper as nm, useFormBuilder as nn, removeMissingReferences as no, DuplicateActionProps as np, ArrayOfPrimitiveOptionsInput as nr, BooleanFieldProps as ns, NewDocumentOptionsResolver as nt, TextWithToneProps as nu, PartialIndexSettings as nv, CommandListHandle as nw, defaultTemplatesForSchema as nx, WorkspacesProvider as ny, CreateWorkspaceFromConfigOptions as o, PreparedSnapshot as oC, RemoteSnapshotEvent as oS, Studio as o_, useDocumentPairPermissions as oa, UseTranslationResponse as ob, Uploader as oc, isReleasePerspective as od, isRecord as of, ScrollContainer as og, BaseEvent as oh, DocumentPreviewPresence as oi, HiddenField as ol, FieldPreviewComponent as om, ObjectMembersProps as on, ParsedTimeRef as oo, EditScheduleForm as op, VirtualizerScrollInstance as or, ObjectFieldProps as os, PreparedConfig as ot, RovingFocusNavigationType as ou, SearchContextValue as ov, BetaBadge as ow, TemplateArrayFieldDefinition as ox, validateBasePaths as oy, createPlugin as p, ReleaseAvatar as pC, useConnectionState as pS, LiveManifestRegisterProvider as p_, useResolveInitialValueForType as pa, defineLocale as pb, FormProvider as pc, ReleasesUpsellContextValue as pd, EMPTY_ARRAY as pf, CollapseMenu as pg, EditDocumentVersionEvent as ph, useResourceCache as pi, PrimitiveFormNode as pl, ChangeTitleSegment as pm, MemberItemError as pn, DocumentVersionEvent as po, PerspectiveNotWriteableReason as pp, HoveredFieldProvider as pr, BooleanInputProps as ps, Source as pt, TemplatePreview as pu, I18nSearchOperatorNameKey as pv, ConnectionStatus as pw, useSyncState as px, ActiveWorkspaceMatcher as py, DocumentLanguageFilterResolver as q, Chip as qC, ApiConfig as qS, LogoProps as q_, snapshotPair as qa, useTimeAgo as qb, ArrayOfPrimitivesItemMember as qc, _isSanityDocumentTypeDefinition as qd, DocumentActionComponent as qf, UpsellDialogUpgradeCtaClicked as qg, isSanityCreateLinked as qh, TemplatePermissionsResult as qi, UserAvatar as ql, NumberDiff$1 as qm, DateTimeInput as qn, FormBuilderInputComponentMap as qo, FromToProps as qp, FieldPresenceInner as qr, ArrayInputMoveItemEvent as qs, AuthProvider as qt, useCopyErrorDetails as qu, StudioTheme as qv, ListenerEvent as qx, Loadable as qy, useConfigContextFromSource as r, ObserveDocumentAvailabilityFn as rC, DocumentRebaseEvent as rS, StudioAnnouncementsDialog as r_, DocumentPairPermissionsOptions as ra, defaultLocale as rb, ResolvedUploader as rc, isPublishedPerspective as rd, PartialExcept as rf, SanityCreateConfigProvider as rg, useEventsStore as rh, RegionWithIntersectionDetails as ri, BooleanFormNode as rl, DiffInspectWrapperProps as rm, useDocumentForm as rn, SelectionState as ro, DuplicateDocumentActionComponent as rp, ArrayOfOptionsInput as rr, FieldCommentsProps as rs, PartialContext as rt, StatusButton as ru, useSearchMaxFieldDepth as rv, CommandListItemContext as rw, prepareTemplates as rx, WorkspacesProviderProps as ry, createSourceFromConfig as s, PreviewPath as sC, SnapshotEvent as sS, StudioProps as s_, useDocumentPairPermissionsFromHookFactory as sa, useTranslation as sb, UploaderDef as sc, isGoingToUnpublish as sd, isNonNullable as sf, ScrollContainerProps as sg, CreateDocumentVersionEvent as sh, DocumentPreviewPresenceProps as si, NodeChronologyProps as sl, DiffErrorBoundary as sm, ObjectInputMember as sn, Timeline as so, useSetPerspective as sp, useVirtualizerScrollInstance as sr, PrimitiveFieldProps as ss, ReleaseActionsResolver as st, RovingFocusProps as su, SearchFilterDefinition as sv, BetaBadgeProps as sw, TemplateFieldDefinition as sx, validateNames as sy, ActiveWorkspaceMatcherContextValue as t, Id as tC, CommittedEvent as tS, isValidAnnouncementAudience as t_, getDocumentValuePermissions as ta, TranslateComponentMap as tb, AssetSourcesResolver as tc, getDocumentIsInPerspective as td, isCardinalityOneRelease as tf, CreateLinkedSanityDocument as tg, FieldValueError as th, PresentUser as ti, ArrayOfPrimitivesFormNode as tl, DiffStringSegment as tm, toMutationPatches as tn, createHistoryStore as to, DocumentActionProps as tp, ArrayOfPrimitivesFunctions as tr, BaseFieldProps as ts, NewDocumentOptionsContext as tt, TextWithTone as tu, SearchButton as tv, CommandListGetItemSelectedCallback as tw, defaultTemplateForType as tx, matchWorkspace as ty, prepareConfig as u, Selection as uC, useDateTimeFormat as uS, useSource as u_, Grant as ua, useGetI18nText as ub, StudioReferenceInputProps as uc, LATEST as ud, getReferencePaths as uf, CollapseMenuButtonProps as ug, DeleteDocumentVersionEvent as uh, ResourceCache as ui, ObjectArrayFormNode as ul, DiffCard as um, MemberFieldError as un, DocumentRemoteMutationVersionEvent as uo, useExcludedPerspective as up, useDidUpdate as ur, ArrayOfPrimitivesElementType as us, ScheduledPublishingPluginOptions as ut, RelativeTimeProps as uu, SearchOperatorType as uv, CONNECTING as uw, TemplateReferenceTarget as ux, getNamelessWorkspaceIdentifier as uy, ConfigResolutionError as v, ReleaseId as vC, ChangeIndicatorsTracker as vS, StudioWorkspaceManifest as v_, useDocumentValues as va, LocaleProviderBase as vb, defaultRenderBlock as vc, isReleaseDocument as vd, catchWithCount as vf, useCommentsTelemetry as vg, ScheduleDocumentVersionEvent as vh, useDocumentPreviewStore as vi, IncompatibleTypeError as vl, ChangeListProps as vm, ArrayOfObjectsInputMembers as vn, checkoutPair as vo, getItemKeySegment as vp, FieldActionMenu as vr, ObjectInputProps as vs, Workspace as vt, BlockImagePreview as vu, SearchOperatorButtonValue as vv, createConnectionStatusStore as vw, useRelativeTime as vx, CommentsSelectedPathProvider as vy, AppsOptions as w, DraftId as wC, TrackerContextGetSnapshot as wS, DocumentMeta as w_, createDocumentStore as wa, LocalePluginOptions as wb, EditReferenceLinkComponentProps as wc, isDocumentLimitError as wd, TasksUpsellContextValue as wf, CommentsContextValue as wg, isDeleteDocumentGroupEvent as wh, useProjectStore as wi, FormFieldGroup as wl, getAnnotationColor as wm, TextInput as wn, prepareForPreview as wo, normalizePathSegment as wp, useFormValue as wr, RenderAnnotationCallback as ws, ReleaseActionsContext as wt, DefaultPreview as wu, defineSearchOperator as wv, createMockAuthStore as ww, useNumberFormat as wx, CommentContext as wy, ConfigPropertyErrorOptions as x, TargetPerspective as xC, ChangeIndicatorTrackerContextValue as xS, BaseOptions as x_, DocumentStore as xa, LocaleConfigContext as xb, defaultRenderInput as xc, DEFAULT_ANNOTATIONS as xd, LegacyThemeProps as xf, useCommentsEnabled as xg, UpdateLiveDocumentEvent as xh, useHistoryStore as xi, MixedArrayError as xl, useDiffAnnotationColor as xm, ArrayOfObjectsMemberProps as xn, createBufferedDocument as xo, normalizeIndexSegment as xp, useGetFormValue as xr, PrimitiveInputElementProps as xs, ReleaseActionComponent as xt, MediaPreviewProps as xu, SearchValueFormatterContext as xv, isCookielessCompatibleLoginMethod as xw, useReconnectingToast as xx, CommentsEnabledProvider as xy, ConfigResolutionErrorOptions as y, ReleasesNavMenuItemPropsGetter as yC, useChangeIndicatorsReportedValues as yS, CopyPasteProvider as y_, DocumentTypeResolveState as ya, ImplicitLocaleResourceBundle as yb, defaultRenderField as yc, MetadataWrapper as yd, defaultTheme as yf, useCommentsSelectedPath as yg, UnpublishDocumentEvent as yh, useDocumentStore as yi, InvalidItemTypeError as yl, ChangeBreadcrumb as ym, ArrayOfObjectsInputMembersProps as yn, BufferedDocumentEvent as yo, getValueAtPath as yp, FieldActionMenuProps as yr, OnPathFocusPayload as ys, WorkspaceOptions as yt, BlockImagePreviewProps as yu, SearchOperatorInput as yv, onRetry as yw, DocumentField as yx, CommentsIntentProvider as yy, DocumentActionsVersionType as z, isDraftId as zC, useOnlyHasVersions as zS, FormUnsetPatch as z_, emitOperation as za, UserWithPermission as zb, UseFormStateOptions as zc, sliceString as zd, ScheduledBadge as zf, ErrorMessageProps as zg, UserColor as zh, PresenceLocation as zi, prefixPath as zl, DiffComponentResolver as zm, UpdateReadOnlyPlugin as zn, isBooleanInputProps as zo, RevertChangesButton as zp, FormFieldHeaderTextProps as zr, BlockDecoratorProps as zs, DocumentFieldActionItem as zt, PopoverDialog as zu, ColorSchemeProvider as zv, useDocumentOperation as zx, CommentTextSelection as zy };