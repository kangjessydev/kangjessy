...
import { Button, ErrorBoundary } from "./TooltipDelayGroupProvider.js";
import { assignId, useStructureTool, LOADING_PANE, useDocumentLastRev, PaneLayout, LoadingPane, StructureToolPane, setActivePanes } from "./pane.js";
...
function useResolvedPanes() {
  const $ = c(15), [error, setError] = useState(), [maximizedPane, setMaximizedPane] = useState(null);
  if (error)
    throw error;
  const {
    structureContext,
