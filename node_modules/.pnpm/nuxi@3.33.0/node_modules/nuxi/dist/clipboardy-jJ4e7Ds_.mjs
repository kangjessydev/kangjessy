...
var termux_default = clipboard$4;
...
const platformLib = (() => {
	switch (process$1.platform) {
		...
		default:
			if (is_wsl_default) return windows_default;
...
var clipboardy_default = clipboard;

//#endregion
export { clipboardy_default as default };