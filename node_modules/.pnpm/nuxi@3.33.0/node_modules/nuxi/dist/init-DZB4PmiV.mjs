...
import { n as R } from "./dist-KRhCJXtj.mjs";
import { o as logLevelArgs, t as cwdArgs } from "./_shared-CoPxtaYg.mjs";
import { t as runCommand } from "./run-CnXlOE2S.mjs";
import { _ as Ct, a as Ie, c as Pt, d as Wt, f as Xt, h as qt, l as Qt, n as logger, o as Mt, s as Nt, u as Tt } from "./logger-C9cMUJ6F.mjs";
import { a as join, c as resolve, s as relative, t as basename } from "./pathe.M-eThtNZ-0R4k6vpe.mjs";
import "./defu-DcpjBOZc.mjs";
import { r as relativeToProcess } from "./kit-BqwTIe0r.mjs";
import { a as writePackageJSON, r as readPackageJSON, t as findFile } from "./dist-DNHJ2_8F.mjs";
import "./satisfies-B5PBn7KX.mjs";
import { t as getNuxtVersion } from "./versions-B7j3MyFW.mjs";
import "./fs-BgbDM8Fv.mjs";
import { n as K } from "./main-vHWsnO_3.mjs";
import { i as installDependencies } from "./dist-B5XQs0aB.mjs";
import { a as resolve$1, i as relative$1, n as dirname$1, t as basename$1 } from "./nypm-D5A4-HdH.mjs";
import "./jiti-wMqj2WBP.mjs";
import "./node-DJa0Btng.mjs";
import { i as $fetch, n as fetchModules, t as checkNuxtCompatibility } from "./_utils-BWRHxOvD.mjs";
import "./prepare-D6jPlS94.mjs";
import add_default, { t as selectModulesAutocomplete } from "./add-eXXithXn.mjs";
...
//#region ../../node_modules/.pnpm/giget@3.1.1/node_modules/giget/dist/_chunks/giget.mjs
...
async function downloadTemplate(input, options = {}) {
	...
	const { extract } = await import("./tar-BQzOmFD9.mjs").then((n) => n.t);
	await extract({
		file: tarPath,
		cwd: extractPath,
		onReadEntry(entry) {
	...
	if (options.install) {
		...
		const { installDependencies } = await import("./nypm-C3SxJttS.mjs").then((n) => n.t);
...
var init_default = defineCommand({
	...
	async run(ctx) {
		...
		Nt(colors.bold(`Welcome to Nuxt!`.split("").map((m) => `${themeColor}${m}`).join("")));
		let availableTemplates = {};
		if (!ctx.args.template || !ctx.args.dir) {
			const defaultTemplates = await import("./templates-BE-vLfoB.mjs").then((r) => r.templates);
			if (ctx.args.offline || ctx.args.preferOffline) availableTemplates = defaultTemplates;
			else {
				const templatesSpinner = Ie();
