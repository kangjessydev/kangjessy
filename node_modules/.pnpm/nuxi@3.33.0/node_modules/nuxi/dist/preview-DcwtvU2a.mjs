...
import { d as Wt, n as logger, u as Tt } from "./logger-C9cMUJ6F.mjs";
...
const command = defineCommand({
	...
	async run(ctx) {
		...
		Wt(`Running ${colors.cyan(nitroJSON.commands.preview)} in ${colors.cyan(relativeToProcess(outputPath))}`);
