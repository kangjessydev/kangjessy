...
import { d as Wt, g as zt, m as kt, n as logger, s as Nt } from "./logger-C9cMUJ6F.mjs";
import { a as join, c as resolve } from "./pathe.M-eThtNZ-0R4k6vpe.mjs";
import { t as defu } from "./defu-DcpjBOZc.mjs";
import { t as overrideEnv } from "./env-DPrym_Ws.mjs";
import { r as relativeToProcess, t as loadKit } from "./kit-BqwTIe0r.mjs";
import { i as FastURL, r as NodeResponse, t as serve } from "./node-AZ4-UAe4.mjs";
import { n as clearDir } from "./fs-BgbDM8Fv.mjs";
...
var analyze_default = defineCommand({
	...
	async run(ctx) {
		...
		Nt(colors.cyan("Analyzing bundle size..."));
		...
		nuxt.options.build.analyze = defu(nuxt.options.build.analyze, { filename: join(analyzeDir, "client.html") });
		const tasklog = zt({
		...
		} else Wt("✨ Analysis build complete!");
	}
});
