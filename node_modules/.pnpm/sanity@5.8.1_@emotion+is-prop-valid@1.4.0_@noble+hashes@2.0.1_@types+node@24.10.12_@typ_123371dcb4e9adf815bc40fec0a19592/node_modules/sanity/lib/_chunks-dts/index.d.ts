...
/** @internal */
declare function ConfirmDeleteDialogContainer(props: ConfirmDeleteDialogProps): react633.JSX.Element;
interface PaneProps {
  children?: ReactNode;
 ...
 * @internal
 */
declare const Pane: react633.ForwardRefExoticComponent<Omit<PaneProps & Omit<CardProps, "as" | "overflow"> & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "hidden" | "id" | "style">, "ref"> & react633.RefAttributes<HTMLDivElement>>;
 ...
 * @internal
 */
declare const PaneContent: react633.ForwardRefExoticComponent<PaneContentProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & react633.RefAttributes<HTMLDivElement>>;
/**
 *
 * @hidden
 ...
 * @beta This API will change. DO NOT USE IN PRODUCTION.
 */
declare function PaneLayout(props: PaneLayoutProps & CardProps & Omit<HTMLProps<HTMLDivElement>, 'as' | 'height' | 'ref' | 'wrap'>): react633.JSX.Element;
/**
 *
 * @hidden
 * @beta
...
declare const structureLocaleStrings: {
  /** Label for the "Copy Document URL" document action */'action.copy-document-url.label': string; /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  'action.publish.running.label': string; /** Tooltip when the "Publish" document action is disabled due to validation issues */
  ...
  'panes.document-operation-results.operation-success': string; /** The text when copy URL operation succeeded  */
 ...
 * @internal
 */
declare const DocumentPane: react633.NamedExoticComponent<DocumentPaneProviderProps>;
/**
 * @internal
 */
 ...
 * @internal
 */
declare const DocumentPaneProviderWrapper: react633.MemoExoticComponent<(props: DocumentPaneProviderProps) => react633.JSX.Element>;
/**
...
/** @internal */
declare function DocumentInspectorHeader(props: DocumentInspectorHeaderProps & Omit<HTMLProps<HTMLDivElement>, 'as' | 'height' | 'ref'>): react633.JSX.Element;
/** @internal */
declare function useDocumentPane(): DocumentPaneContextValue;
/**
 * @internal
 */
declare const PaneContainer: react633.NamedExoticComponent<BaseStructureToolPaneProps<"documentList">>;
/**
 * @internal
 */
 ...
 * ```
 * */
declare const structureTool: sanity3.Plugin<void | StructureToolOptions>;
/** @internal */
...
export { PaneContent as C, BaseStructureToolPaneProps as D, ConfirmDeleteDialogProps as E, PaneLayout as S, ConfirmDeleteDialogContainer as T, StructureLocaleResourceKeys as _, structureTool as a, IncomingReferenceAction as b, useDocumentPane as c, useDocumentTitle as d, DocumentPaneProviderWrapper as f, structureLocaleNamespace as g, DocumentPaneProviderProps as h, StructureToolProviderProps as i, DocumentInspectorHeader as l, usePaneOptions as m, useStructureTool as n, DocumentListPaneProps as o, DocumentPane as p, StructureToolProvider as r, PaneContainer as s, PaneRouterContext as t, UseDocumentTitle as u, isIncomingReferenceCreation as v, Pane as w, usePaneRouter as x, defineIncomingReferenceDecoration as y };