import { i as __require, n as __esmMin, t as __commonJSMin } from "./chunk-DPkJJFeX.mjs";
...
import { i as c, o as v, t as D } from "./dist-KRhCJXtj.mjs";
import { r as version } from "./package-vAVTxU4x.mjs";
import { a as legacyRootDirArgs, t as cwdArgs } from "./_shared-CoPxtaYg.mjs";
import { n as logger, u as Tt } from "./logger-C9cMUJ6F.mjs";
import { c as resolve } from "./pathe.M-eThtNZ-0R4k6vpe.mjs";
import { n as tryResolveNuxt } from "./kit-BqwTIe0r.mjs";
import { r as readPackageJSON } from "./dist-DNHJ2_8F.mjs";
import "./satisfies-B5PBn7KX.mjs";
import "./versions-B7j3MyFW.mjs";
import { t as getBuilder } from "./banner-B_0Op0tw.mjs";
import "./main-vHWsnO_3.mjs";
import { r as detectPackageManager } from "./dist-B5XQs0aB.mjs";
import { t as formatInfoBox } from "./formatting-M7Z8mA-1.mjs";
import { t as getPackageManagerVersion } from "./packageManagers-BOw8trpL.mjs";
import path from "node:path";
import process$1 from "node:process";
import { fileURLToPath } from "node:url";
import os from "node:os";

//#region ../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/darwin.js
...
//#endregion
//#region ../../node_modules/.pnpm/tsdown@0.20.1_oxc-resolver@11.17.0_synckit@0.11.12_typescript@5.9.3/node_modules/tsdown/esm-shims.js
...
var require_streams = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Buffer$2 = __require("buffer").Buffer, Transform = __require("stream").Transform;
	...
	IconvLiteDecoderStream.prototype._transform = function(chunk, encoding, done) {
		if (!Buffer$2.isBuffer(chunk)) return done(/* @__PURE__ */ new Error("Iconv decoding stream needs buffers as its input."));
		try {
			var res = this.conv.write(chunk);
	...
	module.exports = function(iconv) {
		...
		iconv.extendNodeEncodings = function extendNodeEncodings() {
			...
			SlowBuffer.prototype.toString = function(encoding, start, end) {
				...
				if (Buffer$1.isNativeEncoding(encoding)) return original.SlowBufferToString.call(this, encoding, start, end);
			...
			SlowBuffer.prototype.write = function(string, offset, length, encoding) {
				...
				encoding = String(encoding || "utf8").toLowerCase();
				if (Buffer$1.isNativeEncoding(encoding)) return original.SlowBufferWrite.call(this, string, offset, length, encoding);
			...
			Buffer$1.byteLength = SlowBuffer.byteLength = function(str, encoding) {
				encoding = String(encoding || "utf8").toLowerCase();
				if (Buffer$1.isNativeEncoding(encoding)) return original.BufferByteLength.call(this, str, encoding);
				return iconv.encode(str, encoding).length;
			};
			original.BufferToString = Buffer$1.prototype.toString;
			Buffer$1.prototype.toString = function(encoding, start, end) {
				encoding = String(encoding || "utf8").toLowerCase();
				if (Buffer$1.isNativeEncoding(encoding)) return original.BufferToString.call(this, encoding, start, end);
				if (typeof start == "undefined") start = 0;
				if (typeof end == "undefined") end = this.length;
				return iconv.decode(this.slice(start, end), encoding);
			};
			...
			Buffer$1.prototype.write = function(string, offset, length, encoding) {
				...
				encoding = String(encoding || "utf8").toLowerCase();
				if (Buffer$1.isNativeEncoding(encoding)) return original.BufferWrite.call(this, string, _offset, _length, _encoding);
				offset = +offset || 0;
				var remaining = this.length - offset;
				if (!length) length = remaining;
				else {
...
//#endregion
//#region ../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/win32.js
var require_win32 = /* @__PURE__ */ __commonJSMin(((exports) => {
	init_esm_shims();
	const iconv = require_lib();
	const vbsPath = __require("node:path").join(__dirname, ".\\fallbacks\\paste.vbs");
	const paste = {
		command: "cscript",
		args: ["/Nologo", vbsPath]
	};
...
//#endregion
//#region ../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/linux-wayland.js
var require_linux_wayland = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region ../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/linux.js
...
//#endregion
//#region ../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/android.js
var require_android = /* @__PURE__ */ __commonJSMin(((exports) => {
	exports.copy = {
...
//#endregion
//#region ../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/index.js
var require_copy_paste = /* @__PURE__ */ __commonJSMin(((exports) => {
	const child_process = __require("node:child_process");
	...
	switch (process.platform) {
		case "darwin":
			config = require_darwin();
			break;
		case "win32":
			config = require_win32();
			break;
		case "linux":
			if (process.env.WAYLAND_DISPLAY) config = require_linux_wayland();
			else config = require_linux();
			break;
		case "freebsd":
			config = require_linux();
			break;
		case "openbsd":
			config = require_linux();
			break;
		case "android":
			config = require_android();
			break;
	...
	exports.copy = (text, callback) => {
		...
		child.on("exit", () => done(null, text)).on("error", (err) => done(err)).stderr.on("data", (chunk) => err.push(chunk)).on("end", () => {
	...
	exports.paste = (callback) => {
		...
		child.stdout.on("data", (chunk) => data.push(chunk)).on("end", () => done(null, config.decode(data)));
		child.stderr.on("data", (chunk) => err.push(chunk)).on("end", () => {
			if (err.length === 0) return;
			done(new Error(config.decode(err)));
		});
	};
	exports.paste.json = (callback) => !callback ? JSON.parse(exports.paste()) : exports.paste((err, text) => callback(err, text && JSON.parse(text)));
	exports.global = () => {
...
var import_copy_paste = require_copy_paste();
var info_default = defineCommand({
	...
	async run(ctx) {
		...
		const infoObj = {
			...
			...c ? { "Bun version": Bun?.version } : D ? { "Deno version": Deno?.version.deno } : { "Node.js version": process$1.version },
		...
		for (const [label, value] of entries) if (!v) copyStr += `| ${`**${label}**`.padEnd(firstColumnLength)} | ${(value.includes("`") ? value : `\`${value}\``).padEnd(secondColumnLength)} |\n`;
		if (!v && await new Promise((resolve) => (0, import_copy_paste.copy)(copyStr, (err) => resolve(!err)))) Tt(`\n${boxStr}`, ` Nuxt project info ${colors.gray("(copied to clipboard) ")}`, {
			contentAlign: "left",
			titleAlign: "left",
			width: "auto",
			titlePadding: 2,
...
async function getNuxtConfig(rootDir) {
	try {
		const { createJiti } = await import("./jiti-CEnQXjI8.mjs");
